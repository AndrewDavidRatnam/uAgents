...
#get address after running restaurant agent
...
async def handle_query_response(ctx: Context, sender:str, msg: QueryTableResponse):
    ...
    if len(msg.tables) > 0:
        ...
        ctx.logger.info("Request Sent to book")
...
async def handle_book_responses(ctx: Context, _sender: str, msg: BookTableResponse):
    if msg.success:
