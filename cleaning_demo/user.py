...
from protocols.cleaning import (
    ServiceBooking, BookingResponse, 
...
#EVENT HANDLER TO HANDLE REQUESTs
...
#Service Queries and genrerating service bookings
...
async def handle_book_response(ctx: Context, _sender: str, msg: BookingResponse):
    if msg.success:
        ...
        ctx.logger.info("Booking was unsucessful")
